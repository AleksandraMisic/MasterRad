...
namespace DMSService
{
    public class ClientService : IClient
    {
        ...
        public List<Element> GetNetwork(string mrid)
        {
            ...
            if((element = DMSService.Instance.Tree.Data.Values.Where(e => e.MRID == mrid).FirstOrDefault()) != null)
            {
        ...
        private void TraceDownNetwork(Branch branch, List<Element> list)
        {
            ...
            {
                Element element;
                DMSService.Instance.Tree.Data.TryGetValue(branch.End2, out element);
                ...
                {
                    DMSService.Instance.Tree.Data.TryGetValue(id, out element);
        ...
        //                        SwitchStateReport elementStateReport = new SwitchStateReport() { MrID = sw.MRID, Time = DateTime.UtcNow, State = 0 };
