...
//                    imsClient = new IMSProxy(new EndpointAddress("net.tcp://localhost:6090/IncidentManagementSystemService"), binding);
//                }
//                return imsClient;
//            }
//            set { imsClient = value; }
...
//        private SCADAProxy scadaClient;
//        private SCADAProxy ScadaClient
//        {
//            get
//            {
...
//                if (scadaClient == null)
//                {
//                    scadaClient = new SCADAProxy(new EndpointAddress("net.tcp://localhost:4000/SCADAService"), binding);
//                }
//                return scadaClient;
//            }
